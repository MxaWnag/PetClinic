...
urlpatterns = [
    ...
    path('deleteQuestionfromPaper/', views.DeleteQuestionfromPaperView.as_view()),
    path('editPaper/', views.EditPaperView.as_view()),
    path('caseGroup/', views.CaseGroupView.as_view()),
